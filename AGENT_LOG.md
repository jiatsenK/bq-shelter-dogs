...
- 驗證：tests/index.html 新增 1 項，本機 102 項過；1 項失敗是 #79 測試寫死「隔天＝2026-09-26」，今天剛好就是那天，main 上一樣失敗，票外，已回報 K。本機 Chromium 截圖 320／375／390／430 寬度與放大 200%：101 隻有性別的狗圖示都和犬名第一行置中對齊、卡片沒有溢出。截圖 previews/issue-93/。iPhone 實機仍待 K 驗收。
